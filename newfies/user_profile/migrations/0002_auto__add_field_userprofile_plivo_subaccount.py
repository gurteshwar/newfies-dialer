...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.plivo_subaccount'
        db.add_column('user_profile', 'plivo_subaccount',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plivo_cloud.PlivoSubAccount'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.plivo_subaccount'
        db.delete_column('user_profile', 'plivo_subaccount_id')
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            'plivo_subaccount': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['plivo_cloud.PlivoSubAccount']", 'null': 'True', 'blank': 'True'}),
