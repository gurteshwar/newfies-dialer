...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.aleg_gateway'
        db.alter_column(u'dialer_campaign', 'aleg_gateway_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dialer_gateway.Gateway']))

    def backwards(self, orm):

        # Changing field 'Campaign.aleg_gateway'
        db.alter_column(u'dialer_campaign', 'aleg_gateway_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dialer_gateway.Gateway']))
    ...
    models = {
        ...
        u'dialer_campaign.campaign': {
            ...
            'aleg_gateway': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'A-Leg Gateway'", 'null': 'True', 'blank': 'True', 'to': u"orm['dialer_gateway.Gateway']"}),
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'QWZPZ'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 17, 0, 0)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 16, 0, 0)'}),
